...
"""! Closes a telescopes enclosure
Usage:
    'python close_enclosure.py --debug=<true/false>'
"""
...
if (not util.check_enclosure_open(session, protocol, telescope)):
    print(f"The enclosure for telescope '{telescope_name}' is already closed")
    exit()

util.close_enclosure(session, protocol, telescope)
print(f"enclosure for telescope {telescope_name} closing")

...
"""! opens a telescope's enclosure
Usage:
    'python open_enclosure.py --debug=<true/false>'
"""
...
if (util.check_enclosure_open(session, protocol, telescope)):
    print(f"The enclosure for telescope '{telescope_name}' is already open")
    exit()

util.open_enclosure(session, protocol, telescope)
print(f"enclosure for telescope {telescope_name} openning")